...
const reducer = createReducer(initState,
  on(setLaboratoireValue, (state, {laboratoireValue}) => {
    ...
    return {...state, laboratoireValues: list, laboratoireValue: laboratoireValue, dataState: DataStateEnum.LOADED, messages: []}
  }),
  ...
  on(loadLaboratoireValue, (state, {laboratoireValues}) => ({...state, laboratoireValues: laboratoireValues, dataState: DataStateEnum.LOADED, messages: []})),
