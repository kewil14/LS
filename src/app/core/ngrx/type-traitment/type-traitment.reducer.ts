...
const reducer = createReducer(initState,
  on(setTypeTraitment, (state, {typeTraitment}) => {
    ...
    return {...state, typeTraitments: list, typeTraitment: typeTraitment, dataState: DataStateEnum.LOADED, messages: []}
  }),
  ...
  on(loadTypeTraitment, (state, {typeTraitments}) => ({...state, typeTraitments: typeTraitments, dataState: DataStateEnum.LOADED, messages: []})),
